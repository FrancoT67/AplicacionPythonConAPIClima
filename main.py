...
class Ventana(Frame):
	...
	def obtener_tiempo(self):
		...
		API='https://api.openweathermap.org/data/2.5/weather?q=' +ciudad+ '&appid=36fbf81ad749e46ddc8d3d0441c6b3b0'
		try:
...
if __name__ == "__main__":
	...
	ventana.call('wm','iconphoto', ventana._w, PhotoImage(file='temperaturas.png'))
